...
class DineFlowRBACTests(TestCase):
    ...
    def test_waiter_cannot_access_restricted_modules(self):
        ...
        waiter = User.objects.filter(userprofile__role__code='waiter').first()
    ...
    def test_kitchen_cannot_access_billing_or_payroll(self):
        ...
        kitchen = User.objects.filter(userprofile__role__code='kitchen').first()
    ...
    def test_hr_cannot_access_kds_or_backup(self):
        ...
        hr = User.objects.filter(userprofile__role__code='hr').first()
    ...
    def test_logout_destroys_session_and_redirects(self):
        ...
        owner = User.objects.filter(userprofile__role__code='owner').first()
